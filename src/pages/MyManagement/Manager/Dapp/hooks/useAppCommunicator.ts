...
export const useAppCommunicator = (
  ...
  useEffect(() => {
    ...
    const initCommunicator = (
      ...
      // console.log('communicatorInstance', communicatorInstance)
  ...
  // console.log('app', safeAppWeb3Provider)
  ...
  useEffect(() => {
    ...
    // 这一句实现的登录
    // console.log(1111, Methods.getSafeInfo, 'getSafeInfo', handlers.onGetSafeInfo())
