...
const APP_LOAD_ERROR =
  'There was an error loading the Safe App. There might be a problem with the Safe App provider.'
...
export const useAppIsLoading = (): UseAppIsLoadingReturnType => {
