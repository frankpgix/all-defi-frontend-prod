...
export const Infinite: FC<{ white?: boolean; black?: boolean }> = ({ white, black }) => (
  <svg width="28" height="14" viewBox="0 0 28 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill={white ? '#ffffff' : black ? '#2c2626' : '#1036E6'}
    />
  </svg>
)
...
const Bench: FC = () => {
  ...
  return (
    <>
      ...
      />
      <MyDeposit Infinite={<Infinite black />} {...{ data, loading, refetch }} />
    </>
  )
}
